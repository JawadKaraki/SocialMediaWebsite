...
<body>
    <div class="link"><a href="login.php">L O G I N</a></div>
    <div class="form">
        <form method="post">
            <label>SIGNUP HERE</label>
            ...
            <input type="text" name="work" placeholder="P  R  O  F  E  S  S  I  O  N" required>
            <input type="text" name="about" placeholder="A  B  O  U  T" required>
